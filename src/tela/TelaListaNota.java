...
public class TelaListaNota extends JInternalFrame implements ActionListener {
	private static final long serialVersionUID = 4145481897494596983L;
	...
	public void alimentarTabela() {
		...
		for (NotaFiscal nf : nfDao.todos()) {
			...
			dtbNotas.addRow(new String[] { String.valueOf(nf.getIdNotaFiscal()), nf.getDataEmissao(),
					String.valueOf(nf.getValorTotal()), nf.getVenda().getCorretor().getPessoa().getNome() });
		}
